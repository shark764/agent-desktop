...
function Dialpad(props) {
  ...
  return (
    <div id={props.id} >
      <TextInput id={`${props.id}TextInput`} cb={props.setDialpadText} disabled={props.inCall} onEnter={props.onEnter} value={props.dialpadText} autoFocus style={styles.dialpadText} />
