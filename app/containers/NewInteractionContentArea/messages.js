...
export default defineMessages({
  ...
  instructions: {
    ...
    defaultMessage: 'Enter a valid phone number to search. If a contact is not found, you may call or SMS that number.',
  },
  searchError: {
    id: 'app.containers.NewInteractionContentArea.searchError',
    defaultMessage: 'An error occurred with the search. Please try again. If the problem persists, contact your administrator.',
  },
  noRecords: {
