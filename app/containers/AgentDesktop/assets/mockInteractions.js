...
const script = new Script({
  elements: [
    ...
    },
    {
      ...
      value:
        'https://s-media-cache-ak0.pinimg.com/originals/8c/d0/6a/8cd06a1e9863595ba76ee9932fc4a164.jpg',
    },
    {
      type: 'checkbox',
...
const emailInteraction = {
  ...
  emailDetails: {
        ...
        headers: [
          ...
          },
          {
            'X-Microsoft-Exchange-Diagnostics':
              '1;MWHPR22MB0528;27:g3U/PO60LY3fQO7LovQAPMK/h9ADwMXBo0yAxqixSnsHVwk8KKif68BbOm0PX9tEwPzJb37bW+cK5jKuZdgg9GX/aFrIXIzYm/eQa87pqp/9kybCSusPkc1lspZGBzbqu4lu0zY/wQJN1gNNAWPiXA==',
          },
          {
            'X-Microsoft-Antispam-Mailbox-Delivery':
              'abwl:0;wl:0;pcwl:0;kl:0;iwl:0;ijl:0;dwl:0;dkl:0;rwl:0;ex:0;auth:1;dest:I;WIMS-SenderIP:104.47.42.62;WIMS-SPF:serenova%2ecom;WIMS-DKIM:serenova%2ecom;WIMS-822:jclowater%40serenova%2ecom;WIMS-PRA:jclowater%40serenova%2ecom;WIMS-AUTH:PASS;ENG:(5061607094)(102400140);',
          },
        ],
    ...
    headers: [
      ...
      {
        Received:
          'from MWHPR22CA0011.namprd22.prod.outlook.com (10.172.163.149) by MWHPR22MB0528.namprd22.prod.outlook.com (10.172.171.18) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384) id 15.1.947.12 via Mailbox Transport; Wed, 15 Mar 2017 16:07:27 +0000',
      },
      {
        Received:
          'from inbound.mail.protection.outlook.com (216.32.180.85) by MWHPR22CA0011.outlook.office365.com (10.172.163.149) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384) id 15.1.977.11 via Frontend Transport; Wed, 15 Mar 2017 16:07:27 +0000',
      },
      {
        Received:
          'from SN1NAM04FT043.eop-NAM04.prod.protection.outlook.com (10.152.88.55) by SN1NAM04HT110.eop-NAM04.prod.protection.outlook.com (10.152.89.168) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384) id 15.1.961.10; Wed, 15 Mar 2017 16:07:26 +0000',
      },
      {
        'Authentication-Results':
          'spf=pass (sender IP is 104.47.42.62) smtp.mailfrom=serenova.com; outlook.com; dkim=pass (signature was verified) header.d=SERENOVA.COM;outlook.com; dmarc=pass action=none header.from=serenova.com;',
      },
      {
        'Received-SPF':
          'Pass (protection.outlook.com: domain of serenova.com designates 104.47.42.62 as permitted sender) receiver=protection.outlook.com; client-ip=104.47.42.62; helo= NAM03-BY2-obe.outbound.protection.outlook.com;',
      },
      {
        Received:
          'from COL004-MC3F22.hotmail.com (10.152.88.57) by SN1NAM04FT043.mail.protection.outlook.com (10.152.89.45) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384) id 15.1.961.10 via Frontend Transport; Wed, 15 Mar 2017 16:07:26 +0000',
      },
      {
        'X-IncomingTopHeaderMarker':
          'OriginalChecksum:B7931E91765CC087916F665CA3A4A278B45245E86F7F0764B7837E1A5CC6E3D0;UpperCasedChecksum:91420C31FD6142BEADD2A7179C79A10F6148B9CB1D69E91CEF4AF69886ABCD1C;SizeAsReceived:4591;Count:36',
      },
      {
        Received:
          'from NAM03-BY2-obe.outbound.protection.outlook.com ([104.47.42.62]) by COL004-MC3F22.hotmail.com over TLS secured channel with Microsoft SMTPSVC(7.5.7601.23143); Wed, 15 Mar 2017 09:07:07 -0700',
      },
      {
        'DKIM-Signature':
      ...
      {
        Received:
          'from MWHPR17MB0957.namprd17.prod.outlook.com (10.173.121.11) by MWHPR17MB0959.namprd17.prod.outlook.com (10.173.121.13) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384) id 15.1.961.17; Wed, 15 Mar 2017 16:07:04 +0000',
      },
      {
        Received:
          'from MWHPR17MB0957.namprd17.prod.outlook.com ([10.173.121.11]) by MWHPR17MB0957.namprd17.prod.outlook.com ([10.173.121.11]) with mapi id 15.01.0961.020; Wed, 15 Mar 2017 16:07:05 +0000',
      },
      {
      ...
      {
        'Message-ID':
          '<MWHPR17MB09577273A3C96A38D6F92945DD270@MWHPR17MB0957.namprd17.prod.outlook.com>',
      },
      {
      ...
      {
        'authentication-results':
          'outlook.com; dkim=none (message not signed) header.d=none;outlook.com; dmarc=none action=none header.from=serenova.com;',
      },
      {
      ...
      {
        'Content-Type':
          'multipart/alternative; boundary="_000_MWHPR17MB09577273A3C96A38D6F92945DD270MWHPR17MB0957namp_"',
      },
      {
      ...
      },
      {
        'X-OriginalArrivalTime':
          '15 Mar 2017 16:07:07.0131 (UTC) FILETIME=[31B604B0:01D29DA6]',
      },
      {
      ...
      {
        'CMM-Authentication-Results':
          'hotmail.com; spf=pass (sender IP is 104.47.42.62; identity alignment result is pass and alignment mode is relaxed) smtp.mailfrom=jclowater@serenova.com; dkim=pass (identity alignment result is pass and alignment mode is relaxed) header.d=serenova.com; x-hmca=pass header.id=jclowater@serenova.com',
      },
      {
      ...
      {
        'CMM-X-Message-Delivery':
          'Vj0xLjE7dXM9MDtsPTE7YT0xO0Q9MTtHRD0xO1NDTD0w',
      },
      {
        'CMM-X-Message-Info':
          '',
      },
      {
      ...
      },
      {
        'X-MS-Exchange-Transport-CrossTenantHeadersStripped':
          'SN1NAM04FT043.eop-NAM04.prod.protection.outlook.com',
      },
      {
        'X-Microsoft-Exchange-Diagnostics':
          '1;SN1NAM04FT043;1:XY2M4sU+LVzdDObUNRMx7E/emC6AXW4s5sFDmuwzViROGRlYLCl393h8dRLIiVlvRkp/K4HFRd0FLmnS4q+PnT+BK3WtXrpnuLmk+1TQ0jneeOB7b17oD5DECrG4Vk16f5oJAMJjXzyiQAgkpbR+2IFwOcKqddD2NIErfIe0MkU=',
      },
      {
        'X-Forefront-Antispam-Report':
          'EFV:NLI;SFV:NSPM;SFS:(98900017);DIR:INB;SFP:;SCL:1;SRVR:SN1NAM04HT110;H:COL004-MC3F22.hotmail.com;FPR:;SPF:None;LANG:en;',
      },
      {
        'X-Microsoft-Antispam':
          'BCL:0;PCL:0;RULEID:(22001)(8291500097)(8291501071);SRVR:SN1NAM04HT110;',
      },
      {
        'X-Microsoft-Exchange-Diagnostics':
          '1;SN1NAM04HT110;3:;25:;31:xccuSTpSkDdm0wEHcTfxXcbvKi4f2jlNmyaBD103cbsMiziZPCmgL3HeWbVtByg4q/LCQwPxfr6Nb3Pozhp+HGEm74J5IG0A6U5M4GeSOd6XSsOohfomF3/hjJZqurby+A7acq4gv4zR+wxcx3Y/mA==',
      },
      {
      ...
      {
        'X-Microsoft-Exchange-Diagnostics':
          '1;SN1NAM04HT110;24:A4UsPGqqVehd9Yt5n+9RRZX/w+ASOHBiUc7ybxYjiZL6O3QJ0lxEneNFLvuFMZWXAvEdpk8QJcPPI2H5SXQOGCL9jLlhVCiSUR4Pu9KfLPM=;7:',
      },
      {
        'X-MS-Exchange-CrossTenant-OriginalArrivalTime':
          '15 Mar 2017 16:07:26.1530 (UTC)',
      },
      {
    ...
    subject: 'ergerg',
    'content-type':
      'multipart/alternative;  boundary*0=_000_MWHPR17MB09577273A3C96A38D6F92945DD270MWHPR17MB0957namp;  boundary*1=_',
    attachments: [
      {
        filename: 'lgtm.png',
        headers: [
          ...
          {
            contentDisposition:
              'attachment; filename="lgtm.png"; size=6558; creation-date="Mon, 20 Mar 2017 17:12:07 GMT"; modification-date="Mon, 20 Mar 2017 17:12:07 GMT"',
          },
          {
            contentTransferEncoding: 'base64',
          },
          {
            xMicrosoftExchangeDiagnostics:
              '1;MWHPR22MB0528;27:f8r9VLyfgVsPUJ6wrzQyqMyKoyW7dnvXEdSf0HeGtQG2kDCrIyxklY0U9+Iq5MzJjM+tQaJkXiPTnnbsEeOG7Tf63TiyjWPsO4arv+8B9fHi9Tq13PA6SngOyoPpcyVoRrkXq2KUfnSt0+H6UXtZhw==',
          },
          {
            xMicrosoftAntispamMailboxDelivery:
              'abwl:0;wl:1;pcwl:1;iwl:0;rwl:0;ex:0;auth:1;dest:I;WIMS-SenderIP:104.47.34.54;WIMS-SPF:serenova%2ecom;WIMS-DKIM:serenova%2ecom;WIMS-822:jclowater%40serenova%2ecom;WIMS-PRA:jclowater%40serenova%2ecom;WIMS-AUTH:PASS;ENG:(5061607094)(102400140)(102409045);OFR:TrustedSenderList;',
          },
        ],
...
const smoochMessagingInteraction = {
  customFields,
  customFieldsCollapsed: true,
  ...
  interactionId: 'smoochMessagingInteraction',
...
const smsInteractionWithLotsOfMessagesAndScript = {
  ...
  messageHistory: [
    ...
    {
      text:
        'this is a long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long test',
      from: 'Agent',
      type: 'agent',
      timestamp: new Date(
        new Date().setDate(new Date().getDate() + 1)
...
smsInteractionWithLotsOfMessagesAndScript2.interactionId =
  'smsInteractionWithLotsOfMessagesAndScript2';
const smsInteractionWithLotsOfMessagesAndScript3 = cloneDeep(
  smsInteractionWithLotsOfMessagesAndScript
);
smsInteractionWithLotsOfMessagesAndScript3.interactionId =
  'smsInteractionWithLotsOfMessagesAndScript3';
const smsInteractionWithLotsOfMessagesAndScript4 = cloneDeep(
  smsInteractionWithLotsOfMessagesAndScript
);
smsInteractionWithLotsOfMessagesAndScript4.interactionId =
  'smsInteractionWithLotsOfMessagesAndScript4';
const smsInteractionWithLotsOfMessagesAndScript5 = cloneDeep(
  smsInteractionWithLotsOfMessagesAndScript
);
smsInteractionWithLotsOfMessagesAndScript5.interactionId =
  'smsInteractionWithLotsOfMessagesAndScript5';
const smsInteractionWithLotsOfMessagesAndScript6 = cloneDeep(
  smsInteractionWithLotsOfMessagesAndScript
);
smsInteractionWithLotsOfMessagesAndScript6.interactionId =
  'smsInteractionWithLotsOfMessagesAndScript6';

const smsInteractionWithUnrespondedMessageAndScript = cloneDeep(
  smsInteractionWithLotsOfMessagesAndScript
);
smsInteractionWithUnrespondedMessageAndScript.interactionId =
  'smsInteractionWithUnrespondedMessageAndScript';
smsInteractionWithUnrespondedMessageAndScript.messageHistory.splice(6);
const smsInteractionWithUnrespondedMessageAndScript2 = cloneDeep(
  smsInteractionWithUnrespondedMessageAndScript
);
smsInteractionWithUnrespondedMessageAndScript2.interactionId =
