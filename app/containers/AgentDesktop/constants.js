...
export const ADD_SMOOCH_PENDING_MESSAGE =
  'app/AgentDesktop/ADD_SMOOCH_PENDING_MESSAGE';
export const REMOVE_SMOOCH_PENDING_MESSAGE =
  'app/AgentDesktop/REMOVE_SMOOCH_PENDING_MESSAGE';
...
export const UNASSIGNING_CONTACT = 'app/AgentDesktop/UNASSIGNING_CONTACT';
...
export const TOGGLE_IS_MUTING = 'app/AgentDesktop/TOGGLE_IS_MUTING';
export const TOGGLE_IS_HOLDING = 'app/AgentDesktop/TOGGLE_IS_HOLDING';
...
export const SET_TRANSFER_LISTS_FROM_FLOW =
  'app/AgentDesktop/SET_TRANSFER_LISTS_FROM_FLOW';
export const SET_INTERACTION_TRANSFER_LISTS =
  'app/AgentDesktop/SET_INTERACTION_TRANSFER_LISTS';
export const SET_INTERACTION_TRANSFER_LISTS_LOADING_STATE =
  'app/AgentDesktop/SET_INTERACTION_TRANSFER_LISTS_LOADING_STATE';
export const SET_INTERACTION_TRANSFER_LISTS_VISIBLE_STATE =
  'app/AgentDesktop/SET_INTERACTION_TRANSFER_LISTS_VISIBLE_STATE';
export const SET_VISIBLE_STATE_OF_ALL_INTERACTION_TRANSFER_LISTS =
  'app/AgentDesktop/SET_VISIBLE_STATE_OF_ALL_INTERACTION_TRANSFER_LISTS';
export const CRM_DOWNLOAD_COMPLETE = 'app/AgentDesktop/CRM_DOWNLOAD_COMPLETE';
export const SET_MESSAGE_TEMPLATE_FILTER =
  'app/AgentDesktop/SET_MESSAGE_TEMPLATE_FILTER';
export const SET_MESSAGE_TEMPLATE_INDEX =
  'app/AgentDesktop/SET_MESSAGE_TEMPLATE_INDEX';
export const SET_AWAITING_DISPOSITION_SPINNER =
  'app/AgentDesktop/SET_AWAITING_DISPOSITION_SPINNER';

// Saga Constants:
export const UPDATE_INTERACTION_TRANSFER_LISTS_$ =
  'app/AgentDesktop/UPDATE_INTERACTION_TRANSFER_LISTS_$';
export const UPDATE_INTERACTION_TRANSFER_LIST_VISIBLE_STATE_$ =
  'app/AgentDesktop/UPDATE_INTERACTION_TRANSFER_LIST_VISIBLE_STATE_$';
export const UPDATE_VISIBLE_STATE_OF_ALL_INTERACTION_TRANSFER_LISTS_$ =
