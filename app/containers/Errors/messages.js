...
export default defineMessages({
  ...
  incorrectContactsSync: {
    ...
    defaultMessage: 'The new contact that you created the interaction from cannot be searched. Please try searching again to assign the contact to the interaction.',
  },
});
