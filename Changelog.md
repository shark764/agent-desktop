...
### Fixed
* CXV1-24319 - Allow users to switch to non-default SSO tenants after logging in with SSO in Salesforce mode.
...
### Fixed
* CXV1-24111 - Update the Privacy Policy links in Skylight (Desktop).
...
### Fixed
* CXV1-24111 - Update the Privacy Policy links in Skylight (Toolbar).
...
### Added
* CXV1-23209 - Adding transcript for email interactions on contact history panel.
...
### Updated
* CXV1-23200 - Update fallback logic for contact layout category names
...
### Updated
- CXV1-23048 - Audio output translations (notifications -> ringtone)
...
### Changed
No JIRA - (SDK bump) only log console warn instead of messaging module failure when messaging (MQTT) integration not included
...
### Updated
* CXv1-22994 - SDK Bump - Interactions do not re-subscribe to MQTT after MQTT reconnects
...
### Fixed
* CXV1-23001 - Fixed interactions0 showing when earliestTimestamp from reporting is 0

## [1.54.15] (2020-08-12)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.54.15/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.54.15/index.html)
### Fixed
* CXV1-22893 - Removed beta flag for new locales
...
### Changed
* Updating client-strings to v0.1.11 (company name to lifesize, copyright, record)
...
### Changed
* CXV1-22736 - Messages from SDK have been localized.

## [1.51.1] (2020-07-02)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.51.1/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.51.1/index.html)
### Fixed
* CXV1-22769 - Language/locale dropdown styles fixed to avoid causing scrollbars.
...
### Changed
* CXV1-22734 - Update dates and times to use locales | Use of moment.js localization.
...
### Changed
* CXV1-19055 - 1003 Errors impacting Voice functionality when transfering from Salesforce to Agent Desktop

## [1.48.12] (2020-06-22)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.48.12/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.48.12/index.html)
### Changed
* CXV1-12361 - Outbound Email Name not Updating When Assigned

## [1.48.11] (2020-06-22)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.48.11/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.48.11/index.html)
### Changed
* CXV1-22686 - Only do version check for refresh banner on load

## [1.48.10] (2020-06-18)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.48.10/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.48.10/index.html)
### Changed
* CXV1-22689 - Presence List causing "An unknown error has occurred. Please try to finish your work as you may need to refresh the page to continue."​​​​​​​
...
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.48.4/index.html)
### Fixed
* CXV1-22076 - Viewing transcript of interaction that wasn't accepted by first agent, causes loading state in Skylight.
...
### Changed
* CXV1-14373 - TB2 - Timeouts not respected when interaction side panel is closed.
...
### Changed
* CXV1-14876 - Reverting changes for Publish error for Salesforce 'get-org-id'

## [1.47.11] (2020-04-17)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.47.11/index.html)
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.47.11/index.html)
### Changed
- CXV1-18123 - Multiple Attachments Causing Emails to be Unreadable
...
### Changed
* CXV1-14323 - contactHistoryInteraction div does not show Channel type for Outbound Interactions
...
### Changed
* CXV1-10480 - Display Awaiting Disposition loading spinner for all channel types

## [1.47.4] (2020-04-13)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.47.4/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.47.4/index.html)
### Changed
...
### Changed
* CXV1-13350 - Skylight - Update Interaction History Panel to include new Artifact details.
...
### Changed
* CXV1-16016 - Move transfer lists (agents, queues, and transfer lists) into their own component.
...
### Changed
* CXV1-20945 - Presence Reason List Not In Order.

## [1.46.6] (2020-03-17)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.46.6/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.46.6/index.html)
### Changed
* CXV1-21799 - Warm Transfer/Add Participant to queue results in call being offered to agent with customer on hold
...
### Changed
* CXV1-21578 - Removing gap on message templates selection when there is customer indicator.
...
### Changed
* CXV1-21720 - Adding pending message state for sending attachments to smooch.
* CXV1-21736 - Adding beta flag for Skylight attachments.

## [1.45.0] (2020-02-19)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.45.0/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.45.0/index.html)
* CXV1-21426 - Adding support for sending attachments from Skylight to Smooch.
...
### Fixed
* CXV1-21488 - Have the last agent message be scrolled to the bottom.
* CXV1-21513 - Fix smooch customer messages replacing system messages.
...
## Fixed
* CXV1-21347 - Remove Smooch read indicator when an agent sends a message.
...
### Fixed
* CXV1-12990 - Messaging text area cursor focus defaults to end of line when filtering message templates.
...
## [1.42.9] (2019-12-27)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.42.9/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.42.9/index.html)
### Fixed
* CXV1-20779 - Zendesk skylight integration - critical error when clicking elipses
...
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.42.7/index.html)
### Added
* CXV1-21032 - Ignore smooch-typing-agent-received topic

## [1.42.6] (2019-12-10)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.42.6/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.42.6/index.html)
### Fixed
* Login is not rendering spinner
...
### Fixed
* CXV1-20775 - Medium-Draft JS Editor in agent-desktop should be able to handle atomic block html elements.
...
### Added
* CXV1-19735 - Receive smooch conversation history, send smooch messages, receiving smooch messages. UI and redux for typing and read indicators (WIP).
...
### Fixed
* CXV1-17954 - Message Template is not properly formatting.
...
### Changed
* Changed the Jenkins file to correclty shut down old build
...
### Fixed
* CXV1-17542 - Click to dial Outbound identifiers are not working on salesforce lightning contacts
...
## [1.37.10] (2019-03-15)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.37.10/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.37.10/index.html)  
## Fixed
* CXV1-17282 - unable to transfer a voice interaction if it is not the currently selected interaction

## [1.37.9] (2019-03-12)
[test in qe](https://frontend-prs.cxengagelabs.net/qe/builds/skylight/1.37.9/index.html)  
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.37.9/index.html)  
## Fixed
...
[test in dev](https://frontend-prs.cxengagelabs.net/dev/builds/skylight/1.35.14/index.html)  
### Fixed
